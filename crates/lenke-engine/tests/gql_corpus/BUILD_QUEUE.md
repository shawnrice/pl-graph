...
## 1. Edge-label disjunction `-[:A|B]->` — ~24 cases — HIGH VALUE, mechanical
...
- atan2(y,x) (tests_b atan2_*): parser 2-arg group gql.rs 2450; exec 2-arg numeric arm 5927-5934: `x.atan2(y)` (x=args[0],y=args[1]); null->NULL via `_`.
